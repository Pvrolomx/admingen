...
const PLANTILLA_ADMINISTRACION = {
  ...
  bloques: [
    ...
    // EXCLUSIVIDAD DE LISTING PARA VENTA — condicional
    {
      ...
      render: (ctx) => ({
        es: `En el caso de que EL PROPIETARIO decida poner en venta la PROPIEDAD durante la vigencia del presente contrato, EL PROPIETARIO otorga a EL ADMINISTRADOR el derecho de primera opción para listar la PROPIEDAD en exclusiva por un período de 180 (ciento ochenta) días naturales a partir de la notificación por escrito de la intención de venta. Durante dicho período, EL ADMINISTRADOR tendrá el derecho exclusivo de promocionar la PROPIEDAD en el mercado inmobiliario local e internacional, incluyendo pero no limitado a portales inmobiliarios, redes MLS, medios digitales y su red de contactos profesionales. La comisión por intermediación inmobiliaria, los términos de la exclusiva y el precio de lista serán acordados por escrito entre las partes al momento de la notificación de venta. Si al término de los 180 (ciento ochenta) días naturales la PROPIEDAD no se ha vendido, EL PROPIETARIO quedará en libertad de contratar los servicios de cualquier otro agente inmobiliario.\n\nSi durante el período de 180 (ciento ochenta) días de exclusividad pactado, EL PROPIETARIO decidiera contratar los servicios de otro agente inmobiliario para la venta de LA PROPIEDAD o revocar la exclusiva aquí otorgada sin causa imputable a EL ADMINISTRADOR, tal decisión constituirá causa de terminación anticipada del presente contrato de administración. En dicho supuesto, el presente contrato se dará por terminado mediante aviso por escrito con 30 (treinta) días naturales de anticipación, durante los cuales las partes deberán liquidar los saldos pendientes, los recibos por servicios ya comprometidos y demás obligaciones pecuniarias recíprocas derivadas de la administración realizada hasta la fecha efectiva de terminación.`,
        en: `In the event that THE OWNER decides to sell the PROPERTY during the term of this contract, THE OWNER grants THE ADMINISTRATOR the right of first option to exclusively list the PROPERTY for a period of 180 (one hundred eighty) calendar days from the written notification of the intent to sell. During said period, THE ADMINISTRATOR shall have the exclusive right to market the PROPERTY in the local and international real estate market, including but not limited to real estate portals, MLS networks, digital media and their professional network of contacts. The real estate brokerage commission, the terms of the exclusive listing and the listing price shall be agreed upon in writing between the parties at the time of the sale notification. If at the end of the 180 (one hundred eighty) calendar days the PROPERTY has not been sold, THE OWNER shall be free to hire the services of any other real estate agent.\n\nIf during the 180 (one hundred eighty) day exclusivity period, THE OWNER decides to hire the services of another real estate agent for the sale of THE PROPERTY or to revoke the exclusivity granted herein without cause attributable to THE ADMINISTRATOR, such decision shall constitute cause for early termination of this administration contract. In such event, this contract shall be terminated upon written notice with 30 (thirty) calendar days in advance, during which the parties shall settle outstanding balances, invoices for services already committed, and other reciprocal pecuniary obligations arising from the administration carried out up to the effective date of termination.`,
      }),
    },
    ...
    // CLÁUSULA 2 — REPORTES
    {
      ...
      numero: 2,
      siempre: true,
      titulo: { es: 'REPORTE DE GASTOS', en: 'EXPENSES REPORT' },
      render: (ctx) => ({
    ...
    // 3c.2 — GESTIÓN DE IMPUESTOS POR RENTAS (ISR, IVA, ISH)
    {
      id: 'cl_rentas_impuestos',
      condicional: true,
      default: false,
      etiqueta: 'Rentas — gestión fiscal',
      etiqueta_en: 'Rental income — tax management',
      subtitulo: { es: 'c.2).- GESTIÓN DE OBLIGACIONES FISCALES DERIVADAS DE LAS RENTAS', en: 'c.2).- MANAGEMENT OF TAX OBLIGATIONS ARISING FROM RENTAL INCOME' },
      render: (ctx) => ({
        es: `EL ADMINISTRADOR gestionará, por cuenta y orden de EL PROPIETARIO, el cálculo y pago de los impuestos que se deriven de las rentas cobradas, tales como el Impuesto Sobre la Renta (ISR), el Impuesto al Valor Agregado (IVA) y el Impuesto Sobre Hospedaje (ISH) estatal, en los términos establecidos por el Servicio de Administración Tributaria (SAT) y por las autoridades fiscales estatales correspondientes.\n\nEsta gestión estará condicionada a que EL PROPIETARIO proporcione oportunamente la información y documentación necesaria, incluyendo su Registro Federal de Contribuyentes (RFC) activo, constancia de situación fiscal vigente, régimen fiscal aplicable y, en su caso, los accesos a las plataformas digitales de hospedaje (Airbnb, VRBO, Booking, etc.) para la descarga de constancias de retenciones efectuadas por dichas plataformas.\n\nLas partes convienen expresamente que la obligación tributaria sustantiva recae de manera exclusiva en EL PROPIETARIO como sujeto del impuesto, limitándose EL ADMINISTRADOR a las funciones operativas de cálculo, presentación y pago de las contribuciones con cargo a los fondos disponibles en la cuenta de gastos o a las rentas cobradas. EL PROPIETARIO se obliga a mantener su situación fiscal regular y actualizada durante la vigencia del presente contrato.\n\nEn el supuesto de que EL PROPIETARIO no cuente con RFC activo, régimen fiscal adecuado o no proporcione la información requerida, las obligaciones fiscales derivadas de las rentas serán de su exclusiva responsabilidad, quedando EL ADMINISTRADOR liberado de cualquier responsabilidad por omisiones, recargos, actualizaciones, multas o cualquier otra consecuencia fiscal. EL ADMINISTRADOR no asume en ningún caso el carácter de contribuyente, retenedor obligado ni responsable solidario respecto de los impuestos de EL PROPIETARIO, salvo los casos en que la ley expresamente lo determine.`,
        en: `THE ADMINISTRATOR shall manage, on behalf of and by order of THE OWNER, the calculation and payment of taxes arising from the rental income collected, such as Income Tax (ISR), Value Added Tax (IVA), and state Lodging Tax (ISH), in accordance with the terms established by the Tax Administration Service (SAT) and the corresponding state tax authorities.\n\nThis management shall be conditional upon THE OWNER providing timely information and documentation, including their active Federal Taxpayer Registry (RFC), current tax status certificate, applicable tax regime, and, where applicable, access to digital lodging platforms (Airbnb, VRBO, Booking, etc.) for downloading withholding certificates issued by such platforms.\n\nThe parties expressly agree that the substantive tax obligation rests exclusively with THE OWNER as the taxpayer, with THE ADMINISTRATOR being limited to the operational functions of calculating, filing, and paying the contributions charged against funds available in the expenses account or rental income collected. THE OWNER agrees to maintain their tax situation current and up-to-date throughout the term of this contract.\n\nIn the event that THE OWNER does not have an active RFC, an appropriate tax regime, or does not provide the required information, the tax obligations arising from the rental income shall be their exclusive responsibility, releasing THE ADMINISTRATOR from any liability for omissions, surcharges, adjustments, fines, or any other tax consequence. THE ADMINISTRATOR shall not, under any circumstances, assume the status of taxpayer, required withholding agent, or jointly liable party with respect to THE OWNER'S taxes, except in cases expressly determined by law.`,
      }),
    },
